...
func (svc *LndhubService) ConnectSendSubscription(ctx context.Context) (tapd.SubscribeSendAssetEventWrapper, error) {
	...
	return svc.TapdClient.SubscribeSendAssetEvent(ctx, &tapdevrpc.SubscribeSendAssetEventNtfnsRequest{})
}
...
func (svc *LndhubService) HandleTapdSendEvent(ctx context.Context, sendEvent *tapdevrpc.SendAssetEvent, pending []models.TransactionEntry) (err error) {
	// check backoff first
